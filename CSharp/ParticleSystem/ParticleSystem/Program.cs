...
namespace ParticleSystem
{
    class Program
    {
        ...
        private static void GenerateInitialData(Engine engine)
        {
            ...
            ChaoticParticle chaoticParticle = new ChaoticParticle(new MatrixCoords(15, 15), new MatrixCoords(1, 1), RandomGenerator, 50, 50);
           // engine.AddParticle(chaoticParticle);

            ChickenParticle chicken = new ChickenParticle(new MatrixCoords(10, 10), new MatrixCoords(1, 2), RandomGenerator, 13, 37, 12, 15);
            // engine.AddParticle(chicken);

            ParticleRepeller repeller = new ParticleRepeller(new MatrixCoords(13, 13), new MatrixCoords(0, 0), 20, 10);
