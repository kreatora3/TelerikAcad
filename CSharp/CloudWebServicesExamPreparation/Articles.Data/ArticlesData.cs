...
namespace Articles.Data
{
    public class ArticlesData : IArticlesData
    {
        ...
        {
            get { return this.GetRepository<Article>(); }   // Различно за всеки проект !
        }
        ...
        private IRepository<T> GetRepository<T>() where T : class    // copy/paste
        {
        ...
        public int SaveChanges()  // copy/paste
        {
